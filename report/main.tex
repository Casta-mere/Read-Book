...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\newcommand\courseName{Software Eningeering}
...
\ShortHeadings{Coursework of ZSTU - \courseName}{\studentName - \studentNumber}
    \firstpageno{1}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\columnwidth]{figures/safehome2.png}
\end{figure}
